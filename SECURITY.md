...
- Be cautious with `eval()` or dynamic code execution (not applicable to this SDK)
...
- Be aware of dependency vulnerabilities - run `npm audit` regularly

## Security Updates

Security updates will be released as patch versions (e.g., 1.0.1, 1.0.2). We recommend:

- Keeping the SDK updated via npm/yarn
